...
alter table user_item_play ADD CONSTRAINT fk_user_item_play_item_id FOREIGN KEY(item_id) REFERENCES item(id);
...
alter table quest_log ADD CONSTRAINT fk_quest_log_item_id FOREIGN KEY(item_id) REFERENCES item(id);
